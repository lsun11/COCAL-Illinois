subroutine IO_output_cartesian_contour_potential_2pot_test
...
!
  ...
  do iy = 1, ny
    ...
    do ix = 1, nx
      ...
      write(14,'(20es14.6)') x(ix), y(iy), psic, alphc
!
    end do
  end do
  close(14)
!
  ...
  do iz = 1, nz
    ...
    do ix = 1, nx
      ...
      if (dabs(psic).le.small) psic = 0.0d0
      if (dabs(alphc).le.small) alphc = 0.0d0
      write(14,'(20es14.6)') x(ix), z(iz), psic, alphc
!
    end do
  end do
  close(14)
!
  ...
  do iz = 1, nz
    ...
    do iy = 1, ny
      ...
      if (dabs(psic).le.small) psic = 0.0d0
      if (dabs(alphc).le.small) alphc = 0.0d0
      write(14,'(20es14.6)') y(iy), z(iz), psic, alphc
!
    end do
  end do
  close(14)
!
end subroutine IO_output_cartesian_contour_potential_2pot_test
