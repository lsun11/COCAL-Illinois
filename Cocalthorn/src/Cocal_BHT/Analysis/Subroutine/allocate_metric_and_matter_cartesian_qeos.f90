subroutine allocate_metric_and_matter_cartesian_qeos
  use phys_constant, only : long
  use grid_parameter_cartesian, only : nx, ny, nz
  use def_metric_cartesian
  use def_matter_cartesian_qeos
  use make_array_3d
  implicit none
!
  call alloc_array3d(rhoca,1,nx,1,ny,1,nz)
...
!
end subroutine allocate_metric_and_matter_cartesian_qeos
