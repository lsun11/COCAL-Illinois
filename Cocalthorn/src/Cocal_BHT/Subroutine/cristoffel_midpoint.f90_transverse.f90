...
! --  gamma^ab C^c_ab
!
        gmcrix(irg,itg,ipg) = gmxxu*cri(irg,itg,ipg,1,1)       &
           &                + gmxyu*cri(irg,itg,ipg,1,2)*2.0d0 &
           &                + gmxzu*cri(irg,itg,ipg,1,3)*2.0d0 &
           &                + gmyyu*cri(irg,itg,ipg,1,4)       &
           &                + gmyzu*cri(irg,itg,ipg,1,5)*2.0d0 &
           &                + gmzzu*cri(irg,itg,ipg,1,6)
        gmcriy(irg,itg,ipg) = gmxxu*cri(irg,itg,ipg,2,1)       &
           &                + gmxyu*cri(irg,itg,ipg,2,2)*2.0d0 &
           &                + gmxzu*cri(irg,itg,ipg,2,3)*2.0d0 &
           &                + gmyyu*cri(irg,itg,ipg,2,4)       &
           &                + gmyzu*cri(irg,itg,ipg,2,5)*2.0d0 &
           &                + gmzzu*cri(irg,itg,ipg,2,6)
        gmcriz(irg,itg,ipg) = gmxxu*cri(irg,itg,ipg,3,1)       &
           &                + gmxyu*cri(irg,itg,ipg,3,2)*2.0d0 &
           &                + gmxzu*cri(irg,itg,ipg,3,3)*2.0d0 &
           &                + gmyyu*cri(irg,itg,ipg,3,4)       &
           &                + gmyzu*cri(irg,itg,ipg,3,5)*2.0d0 &
           &                + gmzzu*cri(irg,itg,ipg,3,6)
!
! --- Impose Dirac gauge.
!Dirac        gmcrix(irg,itg,ipg) = 0.0d0
!Dirac        gmcriy(irg,itg,ipg) = 0.0d0
!Dirac        gmcriz(irg,itg,ipg) = 0.0d0
! --- end
      end do
    end do
  end do
...
!write(6,'(1p,3e16.8)') hvec_xg(irg,itg,ipg,1), hvec_xg(irg,itg,ipg,2), &
!&                      hvec_xg(irg,itg,ipg,3)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,1), cri(irg,itg,ipg,2,1), &
!&                      cri(irg,itg,ipg,3,1)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,2), cri(irg,itg,ipg,2,2), &
!&                      cri(irg,itg,ipg,3,2)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,3), cri(irg,itg,ipg,2,3), &
!&                      cri(irg,itg,ipg,3,3)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,4), cri(irg,itg,ipg,2,4), &
!&                      cri(irg,itg,ipg,3,4)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,5), cri(irg,itg,ipg,2,5), &
!&                      cri(irg,itg,ipg,3,5)
!write(6,'(1p,3e16.8)') cri(irg,itg,ipg,1,6), cri(irg,itg,ipg,2,6), &
!&                      cri(irg,itg,ipg,3,6)
!stop                                                                          
