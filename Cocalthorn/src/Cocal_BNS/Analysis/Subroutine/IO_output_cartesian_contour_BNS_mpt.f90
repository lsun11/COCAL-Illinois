...
!
     ...
     &  emdc, vxc, vyc, vzc, psic, alphc, bvxc, bvyc, bvzc, hhc, rhoc
!
    end do
  end do
  close(14)
...
!
  ...
  close(14)
!
end subroutine IO_output_cartesian_contour_BNS_mpt
