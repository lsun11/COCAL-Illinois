subroutine calc_corot_BNSmrs_CF_mpt(total_iteration)
  ...
  id = surf_param_int_(2,1)    ! sw_sepa
  im = surf_param_int_(3,1)    ! sw_quant 0=Mo, 1=Madm
  is = surf_param_int_(4,1)    ! sw_spin
 
  niq = 1
  if(id.eq.1)               niq = 2
  if(id.eq.1.and.is.eq.1)   niq = 3
...
end subroutine calc_corot_BNSmrs_CF_mpt
