...
!
!  call alloc_array3d(dgdx,1,nrg,1,ntg,1,npg)
!  call alloc_array3d(dgdy,1,nrg,1,ntg,1,npg)
!  call alloc_array3d(dgdz,1,nrg,1,ntg,1,npg)
!
...
! --- for interporation.
!
!  call grgrad_midpoint(detg_grid_ks,dgdx,dgdy,dgdz)
...
!
        gmcrix(irg,itg,ipg) = -dihixu(irg,itg,ipg)
        gmcriy(irg,itg,ipg) = -dihiyu(irg,itg,ipg)
        gmcriz(irg,itg,ipg) = -dihizu(irg,itg,ipg)

!        if (chgra == 'k') then
!          gg = 2.0d0*detg_ks(irg,itg,ipg)
!
!          gmcrix(irg,itg,ipg) = -Fxu_ks(irg,itg,ipg)         &
!                    &           -(gmxxu*dgdx(irg,itg,ipg) +  &
!                    &             gmxyu*dgdy(irg,itg,ipg) +  &
!                    &             gmxzu*dgdz(irg,itg,ipg))/gg
!
!          gmcriy(irg,itg,ipg) = -Fyu_ks(irg,itg,ipg)         &
!                    &           -(gmyxu*dgdx(irg,itg,ipg) +  &
!                    &             gmyyu*dgdy(irg,itg,ipg) +  &
!                    &             gmyzu*dgdz(irg,itg,ipg))/gg
!
!          gmcriz(irg,itg,ipg) = -Fzu_ks(irg,itg,ipg)         &
!                    &           -(gmzxu*dgdx(irg,itg,ipg) +  &
!                    &             gmzyu*dgdy(irg,itg,ipg) +  &
!                    &             gmzzu*dgdz(irg,itg,ipg))/gg
