...
!
  ...
  implicit none
!
!  real(long), pointer :: pot1(:,:,:), pot2(:,:,:), pot3(:,:,:), pot4(:,:,:), &
!      &                  pot5(:,:,:), pot6(:,:,:)
...
!     &       bdhyy, bdhyz, bdhzz, &
!     &       pdpot1dx,pdpot1dy,pdpot1dz,pdpot2dx,pdpot2dy,pdpot2dz, &
!     &       pdpot3dx,pdpot3dy,pdpot3dz,pdpot4dx,pdpot4dy,pdpot4dz, &
!     &       pdpot5dx,pdpot5dy,pdpot5dz,pdpot6dx,pdpot6dy,pdpot6dz
...
!=============================================================================================
!       Used to fix derivatives of A_{ij} close to BH
!        call grgrad_4th_gridpoint_bhex(hxxd,pdhxxdx,pdhxxdy,pdhxxdz,irg,itg,ipg)
!        call grgrad_4th_gridpoint_bhex(hxyd,pdhxydx,pdhxydy,pdhxydz,irg,itg,ipg)
!        call grgrad_4th_gridpoint_bhex(hxzd,pdhxzdx,pdhxzdy,pdhxzdz,irg,itg,ipg)
!        call grgrad_4th_gridpoint_bhex(hyyd,pdhyydx,pdhyydy,pdhyydz,irg,itg,ipg)
!        call grgrad_4th_gridpoint_bhex(hyzd,pdhyzdx,pdhyzdy,pdhyzdz,irg,itg,ipg)
!        call grgrad_4th_gridpoint_bhex(hzzd,pdhzzdx,pdhzzdy,pdhzzdz,irg,itg,ipg)
