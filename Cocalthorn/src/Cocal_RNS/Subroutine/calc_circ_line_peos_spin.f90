subroutine calc_circ_line_peos_spin(impt)
  ...
  use interface_source_circ_line_peos_spin
...
!
  ...
  do ia = nrf,nrf 
    ...
    call source_circ_line_peos_spin("ph", ia, ib, souf_circ_line_ph_peos)
...
!  write(6,'(a90)') "---------------------------------------------------------------------------------------------"
  do ia = nrf,nrf 
    ...
    call source_circ_line_peos_spin("th", ia, ib, souf_circ_line_th_peos)
...
!      write(6,'(a8,i3,a42,1p,e23.15)') 'For irf=', ia, '  Circulation (line integral) on yz plane=', circ_line_ip
...
end subroutine calc_circ_line_peos_spin
