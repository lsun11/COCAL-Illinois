...
!
  ...
  use def_formulation, only : chgra, shift_scale
!
...
!
  ...
  &          pdbvzdx, pdbvzdy, pdbvzdz, ps4oal2, bbxx, bbxy, bbxz, bbyy, &
...
!
  ...
  deallocate(dfdz)
!
end subroutine excurve_WL_midpoint
