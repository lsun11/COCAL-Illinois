subroutine sourceterm_insurf_ARCP_from_COCP(impt,fnchar,parchar,sou_in,dsou_in)
...
!
  ...
  do impt_bin = 1, 2
    ...
    if (fnchar.eq.'psi ') call copy_array4dto3d_mpt(impt_bin,psi_,fnc_itp, &
    &                                       0,nrg_itp,0,ntg_itp,0,npg_itp)
    if (fnchar.eq.'alps') call copy_array4dto3d_mpt(impt_bin,alps_,fnc_itp, &
    &                                        0,nrg_itp,0,ntg_itp,0,npg_itp)
    if (fnchar.eq.'bvxd') call copy_array4dto3d_mpt(impt_bin,bvxd_,fnc_itp, &
    &                                        0,nrg_itp,0,ntg_itp,0,npg_itp)
    if (fnchar.eq.'bvyd') call copy_array4dto3d_mpt(impt_bin,bvyd_,fnc_itp, &
    &                                        0,nrg_itp,0,ntg_itp,0,npg_itp)
    if (fnchar.eq.'bvzd') call copy_array4dto3d_mpt(impt_bin,bvzd_,fnc_itp, &
    &                                        0,nrg_itp,0,ntg_itp,0,npg_itp)
