...
!
        ...
        Lij_grid(irg,itg,ipg,1,1) = ainvh*(2.0d0*pdbvxdx - gmxxd*diver) 
        Lij_grid(irg,itg,ipg,2,2) = ainvh*(2.0d0*pdbvydy - gmyyd*diver) 
        Lij_grid(irg,itg,ipg,3,3) = ainvh*(2.0d0*pdbvzdz - gmzzd*diver) 
        Lij_grid(irg,itg,ipg,1,2) = ainvh*(pdbvydx + pdbvxdy - gmxyd*diver)
        Lij_grid(irg,itg,ipg,1,3) = ainvh*(pdbvzdx + pdbvxdz - gmxzd*diver)
        Lij_grid(irg,itg,ipg,2,3) = ainvh*(pdbvzdy + pdbvydz - gmyzd*diver)
