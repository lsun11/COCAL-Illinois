subroutine allocate_BNS_CF_spin_mpt
...
!
  ...
  call alloc_array4d(wxspg_, 0, nrg, 0, ntg, 0, npg, 1, nmpt)
  call alloc_array4d(wyspg_, 0, nrg, 0, ntg, 0, npg, 1, nmpt)
  call alloc_array4d(wzspg_, 0, nrg, 0, ntg, 0, npg, 1, nmpt)
!
end subroutine allocate_BNS_CF_spin_mpt
