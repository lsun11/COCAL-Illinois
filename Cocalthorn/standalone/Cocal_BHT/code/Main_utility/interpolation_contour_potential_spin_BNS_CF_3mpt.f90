...
!______________________________________________
PROGRAM interpolation_contour_potential_spin_BNS_CF_3mpt
!
...
!
  do impt = 1, nmpt
    ...
    call IO_input_converged_solution_3D_CF_spin_NS_mpt(impt)
...
!cal      call calc_4velocity_ut_spin
!
!cal      call calc_rest_mass_peos_spin      ! integral over star
!cal      call calc_mass_peos_spin           ! integral over star only for Komar mass
!cal      call calc_proper_mass_peos_spin    ! integral over star
!cal      call calc_ang_mom_peos_spin        ! integral over star
...
!cal      call calc_circ_line_peos_spin(impt)
!cal      call calc_circ_surf_peos_spin(impt)
...
!
END PROGRAM interpolation_contour_potential_spin_BNS_CF_3mpt
