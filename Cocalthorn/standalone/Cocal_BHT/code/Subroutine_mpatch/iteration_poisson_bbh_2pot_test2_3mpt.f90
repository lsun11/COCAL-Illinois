subroutine iteration_poisson_bbh_2pot_test2_3mpt(iter_count)
...
!  use interface_sourceterm_volume_int_bbh_2pot_test
  ...
  use interface_bh_boundary_psi_test2_mpt
  use interface_bh_boundary_alph_test2_mpt
...
!        call poisson_solver_binary_bhex_homosol('nd',sou, &
        call bh_boundary_psi_test2_mpt(impt,'d',sou_bhsurf,dsou_bhsurf)
...
!        call bh_boundary_alph_test_mpt(impt,'n',sou_bhsurf,dsou_bhsurf)
        call bh_boundary_alph_test2_mpt(impt,'d',sou_bhsurf,dsou_bhsurf)
...
end subroutine iteration_poisson_bbh_2pot_test2_3mpt
