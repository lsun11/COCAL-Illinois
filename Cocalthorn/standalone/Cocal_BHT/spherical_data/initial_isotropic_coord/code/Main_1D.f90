...
include 'include_modulefiles_1D.f90'
include 'include_subroutines_1D.f90'
!______________________________________________
!
!              Main Program
!______________________________________________
...
!
  ...
  use grid_parameter_1D, only : iter_max, eps, emdc, nrg, &
...
!
  ...
  integer :: ii, irger, iseq, istat, iter
!
  character*4 char
  character*1 chbhs
!
...
!
      ...
      call sourcetermg(soupsg,souapg,soufpg)
!
...
!
        ...
        call paimproco_frg(ber,radi,convf,iter,fmax0,0)
...
!
      call fluidco(iter,iter_max,convf,cfvep,fmax0,emxemd,char)
