...
include '../Subroutine_mpatch/iteration_poisson_bbh_test_mpt.f90'
...
!              Main Program
!______________________________________________
PROGRAM Main_poisson_binary_test_mpt
!
...
!
!  do itg = 0, ntg
!  write(6,*) itg,plmg(3,2,itg,1)
!  end do
!
   call iteration_poisson_bbh_test_mpt(iter_count)
...
!  write(6,*) nrg, mass_eps, sw_art_deform 
  ...
  !call calc_grid_points_binary_excision
!
END PROGRAM Main_poisson_binary_test_mpt
