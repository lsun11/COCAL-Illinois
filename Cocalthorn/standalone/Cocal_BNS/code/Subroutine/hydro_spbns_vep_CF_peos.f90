subroutine hydro_spbns_vep_CF_peos(vpot,iter,impt,ihy)
  ...
  use interface_source_vep_CF_peos_spin
  ...
  use interface_poisson_solver_homogeneous_sol_spin
...
!
  call source_vep_CF_peos_spin(sou)
  ...
  call poisson_solver_homogeneous_sol_spin(surp,vpot_b)
