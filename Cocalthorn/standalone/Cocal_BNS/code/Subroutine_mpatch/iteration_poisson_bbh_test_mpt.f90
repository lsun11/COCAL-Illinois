subroutine iteration_poisson_bbh_test_mpt(iter_count)
...
!
      call bh_boundary_test_mpt(impt,'dh',sou_bhsurf,dsou_bhsurf)
...
end subroutine iteration_poisson_bbh_test_mpt
