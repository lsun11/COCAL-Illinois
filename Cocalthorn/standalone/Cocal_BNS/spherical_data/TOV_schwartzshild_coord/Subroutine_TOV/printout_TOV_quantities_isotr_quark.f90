subroutine printout_TOV_quantities_isotr_quark
...
!  call peos_h2qprho(hini, qini, pre, rho0, ene)
  call quark_rho2phenedpdrho(rhoini, pre, hh, ene, dpdrho)
  qini=pre/rhoini
  rho0=rhoini
!
...
!
  ...
  write(3 , '(14es14.6)') compa, emdc, rho0, rhocgs, pre, ene, &
...
!
  ...
  close(20)
!
end subroutine printout_TOV_quantities_isotr_quark
