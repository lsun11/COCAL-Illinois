...
# set yrange [-0.2:1.2]
 set terminal x11 1
 plot "plot_x_mpt1.dat" u 1:3 w lp lw 2, \
...
# set yrange [-0.2:1.2]
 set terminal x11 3
 plot "plot_x_mpt1.dat" u 1:5 w lp lw 2, \
      "plot_x_mpt2.dat" u 1:5 w lp lw 2, \
      "plot_x_mpt3.dat" u 1:5 w lp lw 2

 set terminal x11 4
 plot "plot_x_mpt1.dat" u 1:6 w lp lw 2, \
      "plot_x_mpt2.dat" u 1:6 w lp lw 2, \
      "plot_x_mpt3.dat" u 1:6 w lp lw 2
