#!/bin/sh
#
TAG=BBH_CF_trpPunc_3mpt
filename_Maincode=./Main_code/Main_BBH_CF_trpPunc_3mpt.f90
# TAG=BBH_CF_3mpt
# filename_Maincode=./Main_code/Main_BBH_CF_3mpt.f90
## TAG=helmholtz_binary_test_3mpt
## filename_Maincode=./Main_code/Main_helmholtz_binary_test_3mpt.f90
### TAG=poisson_bbh_2pot_test2_3mpt
### filename_Maincode=./Main_code/Main_poisson_bbh_2pot_test2_3mpt.f90
...
sed -i "/allocate_radial_green_fn_hret_mi_hadv\.f90/d"  ${incfile_subrou}
sed -i "/allocate_radial_green_fn_hret_mi_hadv_homosol\.f90/d" ${incfile_subrou}
