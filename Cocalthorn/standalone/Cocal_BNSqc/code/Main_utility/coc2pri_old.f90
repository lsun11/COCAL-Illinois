...
!
  ...
  implicit none
  integer :: impt, impt_ex, ico, irr, isp, path_len
     ...
     do iny=1,Ny
        ...
        do inx=1,Nx
           ...
           if (rrcm > rr3 .and. rrcm < rr_impt3_out) then
              ...
              yc_p3 = ycoc
              zc_p3 = zcoc
              !print *,"xcoc=",xcoc,"ycoc=",ycoc,"zcoc=",zcoc
           ...
           ! Setting up  the Kij, which assuming K=0 is K_ij = A_ij,
           ...
           ! Setting up the Gauge variables
           
           gbtt(inx,iny,inz)=alphca
           gbtx(inx,iny,inz)=bvxdca
           gbty(inx,iny,inz)=bvydca
           gbtz(inx,iny,inz)=bvzdca
