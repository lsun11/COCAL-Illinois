subroutine calc_circ_line_peos
  ...
  use interface_source_circ_line_peos
...
!
  ...
  do ia = nrf,nrf 
    ...
    call source_circ_line_peos("ph", ia, ib, souf_circ_line_ph_peos)
...
!  write(6,'(a90)') "---------------------------------------------------------------------------------------------"
  do ia = nrf,nrf 
    ...
    call source_circ_line_peos("th", ia, ib, souf_circ_line_th_peos)
...
! Output all meridional circulations
  open(12,file='circ_line.dat', status='unknown')
  call alloc_array2d(souf_circ_line_th_peos, 1, 2*ntf, 1, 3)
  do iphi=0,npf/2
    do ia = nrf,nrf
...
end subroutine calc_circ_line_peos
