subroutine calc_integrability_At
...
!
      ...
      va(irg,itg,ipg) = 1.0/alphgg*(- MHDfnc_At &
...
!
  do ipg = 1, npg
    if (rg(irg).gt.rs(itg,ipg)) cycle
    va(0:nrg,0:ntg,ipg) = va(0:nrg,0:ntg,0)
  end do
!
  deallocate(vaphid)
!
end subroutine calc_integrability_At
