cp ../code/Subroutine/calc_omega_drot_Newton.f90_type1type2 \
...
sed -i "s/!rotlaw_type1//g" ../code/Subroutine/calc_omega_drot.f90
#sed -i "s/!rotlaw_type1//g" ../code/Subroutine/calc_omega_drot_Newton.f90
sed -i "s/!rotlaw_type012//g" ../code/Subroutine/calc_omega_drot_secant.f90
sed -i "s/!rotlaw_type12//g" ../code/Subroutine/calc_omega_drot_secant.f90
sed -i "s/!rotlaw_type01//g" ../code/Subroutine/calc_omega_drot_secant.f90
sed -i "s/!rotlaw_type1//g" ../code/Subroutine/calc_omega_drot_secant.f90
sed -i "s/!rotlaw_type1//g" ../code/Subroutine/calc_omega_drot_bisection.f90
sed -i "s/!rotlaw_type1//g" ../code/Subroutine/update_parameter_axisym_peos_drot.f90
