subroutine iter_lecc_spin_BNS_CF_mpt(iter_count, iseq, iter_eps)
...
!
  ...
  use interface_sourceterm_HaC_peos_spin
  use interface_sourceterm_HaC_CF
  use interface_sourceterm_trG_peos_spin
...
! --- psi
      ...
      if (impt==1 .or. impt==2) then
        call sourceterm_HaC_peos_spin(sou)
      else
...
! --- alps
      ...
      if (impt==1 .or. impt==2) then
        call sourceterm_trG_peos_spin(sou)
      else
...
end subroutine iter_lecc_spin_BNS_CF_mpt
