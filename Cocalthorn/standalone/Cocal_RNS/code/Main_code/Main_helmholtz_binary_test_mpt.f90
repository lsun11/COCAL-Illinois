...
!              Main Program
!______________________________________________
PROGRAM Main_helmholtz_binary_test_mpt
!
...
!
  call read_parameter_mpt(3)
  call copy_grid_parameter_to_mpt(3)
  call read_parameter_binary_excision_mpt(3)
  call copy_grid_parameter_binary_excision_to_mpt(3)
!
! -- Allocate arrays
...
!
END PROGRAM Main_helmholtz_binary_test_mpt
