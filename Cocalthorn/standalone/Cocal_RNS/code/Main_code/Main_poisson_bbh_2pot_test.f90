...
include '../Subroutine/iteration_poisson_bbh_2pot_test.f90'
...
!              Main Program
!______________________________________________
PROGRAM Main_poisson_bbh_2pot_test
!
...
! 
  call iteration_poisson_bbh_2pot_test(iter_count)
...
!
END PROGRAM Main_poisson_bbh_2pot_test
