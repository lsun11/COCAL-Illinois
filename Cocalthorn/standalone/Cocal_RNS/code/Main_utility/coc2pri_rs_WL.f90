...
!______________________________________________
!
!      ROTATING STAR COCAL Waveless ID
!______________________________________________
SUBROUTINE coc2pri_rs_WL(dir_path,Xb,Yb,Zb,Nx,Ny,Nz,&
...
!
  integer :: Nx,Ny,Nz,inx,iny,inz,path_len
  ...
  write(*,*) "In coc2pri_rs_WL: dir_path=",dir_path
  ...
  do inz=1,Nz
     ...
     do iny=1,Ny
        ...
        do inx=1,Nx
           ...
           gbxy(inx,iny,inz) = psi4ca*(0.0d0+hxydca)
           gbxz(inx,iny,inz) = psi4ca*(0.0d0+hxzdca)
           gbyy(inx,iny,inz) = psi4ca*(1.0d0+hyydca)
           gbyz(inx,iny,inz) = psi4ca*(0.0d0+hyzdca)
           gbzz(inx,iny,inz) = psi4ca*(1.0d0+hzzdca)
           
           gbxx_t(inx,iny,inz) = psi4ca*axxca/(radi)
           gbxy_t(inx,iny,inz) = psi4ca*axyca/(radi)
           gbxz_t(inx,iny,inz) = psi4ca*axzca/(radi)
           gbyy_t(inx,iny,inz) = psi4ca*ayyca/(radi)
           gbyz_t(inx,iny,inz) = psi4ca*ayzca/(radi)
           gbzz_t(inx,iny,inz) = psi4ca*azzca/(radi)
