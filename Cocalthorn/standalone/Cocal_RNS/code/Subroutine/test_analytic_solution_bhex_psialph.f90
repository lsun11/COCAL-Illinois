subroutine test_analytic_solution_bhex_psialph
...
!
  do ipg = 0, npg
    do itg = 0, ntg
      ...
      &                           - mass/(2.0d0*rb(irg,itg,ipg)))/bvxd(irg,itg,ipg)
      end do
    end do
  end do
!
end subroutine test_analytic_solution_bhex_psialph
