subroutine IO_input_potential_test_3D_mpt(impt)
...
!
! --- Metric potentials.
  open(13,file='rnsgra_3D_mpt'//np(impt)//'.las',status='old')
  ...
  read(13,'(1p,6e20.12)') ome, ber, radi, dis
  close(13)
!
! --- Coordinate grids.
  open(14,file='rnsgrids_3D_mpt'//np(impt)//'.las',status='old')
  ...
  close(14)
!
end subroutine IO_input_potential_test_3D_mpt
