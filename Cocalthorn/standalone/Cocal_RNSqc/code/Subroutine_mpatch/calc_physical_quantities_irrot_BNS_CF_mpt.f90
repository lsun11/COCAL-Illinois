subroutine calc_physical_quantities_irrot_BNS_CF_mpt
...
!!!    call excurve
    if (impt==1 .or. impt==2)  then
      ...
      call calc_rest_mass_peos_irrot      ! integral over star
      call calc_mass_peos_irrot           ! integral over star only for Komar mass
      call calc_proper_mass_peos_irrot    ! integral over star
      call calc_ang_mom_peos_irrot        ! integral over star
...
!      call calc_quad_pole_peos
      ...
      call calc_circ_line_peos_irrot(impt)
      call calc_circ_surf_peos_irrot(impt)
...
!
end subroutine calc_physical_quantities_irrot_BNS_CF_mpt
