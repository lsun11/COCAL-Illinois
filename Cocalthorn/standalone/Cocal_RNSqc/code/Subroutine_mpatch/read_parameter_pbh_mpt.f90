subroutine read_parameter_pbh_mpt(impt)
  ...
  open(1,file='pbhpar_mpt'//np(impt)//'.dat',status='old')
  read(1,'(1p,1e14.6,2x,a3)') mass_pBH, spin_input
  read(1,'(1p,1e14.6,3x,a2)') mass_ratio, bh_soltype
...
end subroutine read_parameter_pbh_mpt
