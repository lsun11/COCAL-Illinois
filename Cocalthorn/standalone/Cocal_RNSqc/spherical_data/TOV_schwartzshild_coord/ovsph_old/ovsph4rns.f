...
c
      dqdq = - (compa-chope)/(compa-compab)*(qini-qinib)
      compab = compa
      qinib= qini
      qini = qini + dqdq
c
c      if (chope.ge.compa.and.compa.ge.compab) then
c      compab = compa
c      qinib= qini
c      qini = qini + dqdq
c      else if (chope.le.compa.and.compa.le.compab) then
c      compab = compa
c      qinib= qini
c      qini = qini - dqdq
c      else
c      qinibx = qini
c      qini = 0.5d0*(qini+qinib)
c      qinib = qinibx
c      dqdq = 0.5d0*dabs(dqdq)
c      end if
c
      erer = dabs((compa-chope)/chope)
c      write(6,*) compab, compa, dqdq
      write(6,620) itcom, erer, qinib, compa
