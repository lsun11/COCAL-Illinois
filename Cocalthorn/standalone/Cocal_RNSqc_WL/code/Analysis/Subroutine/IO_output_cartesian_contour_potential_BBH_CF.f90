subroutine IO_output_cartesian_contour_potential_BBH_CF
  ...
  integer :: ix, iy, iz
!
  open(14,file='BBH_contour_xy.dat',status='unknown')
  iz = nx_mid
  do iy = 1, ny
    write(14,*) ' '
    do ix = 1, nx
...
!
  ...
  close(14)
!
  open(14,file='BBH_contour_xz.dat',status='unknown')
  iy = nx_mid
  do iz = 1, nz
    write(14,*) ' '
    do ix = 1, nx
...
!
  ...
  close(14)
!
  open(14,file='BBH_contour_yz.dat',status='unknown')
  ix = nx_mid
  do iz = 1, nz
    write(14,*) ' '
    do iy = 1, ny
...
!
  ...
  close(14)
!
end subroutine IO_output_cartesian_contour_potential_BBH_CF
