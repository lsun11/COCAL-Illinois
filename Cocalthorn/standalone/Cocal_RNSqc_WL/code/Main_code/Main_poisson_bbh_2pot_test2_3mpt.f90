...
!              Main Program
!______________________________________________
PROGRAM Main_poisson_binary_2pot_test_3mpt
!
...
! -- Analytic solution for 2 potential problem on all patches.
  do impt = 1, nmpt
    ...
    call test2_analytic_solution_bhex_mpt(impt) ! alpha > 0 at bh
    call copy_to_mpatch_all_test(impt)
    call copy_metric_and_matter_BHNS_test_to_mpt(impt)
  end do
!
  call iteration_poisson_bbh_2pot_test2_3mpt(iter_count)
...
!
END PROGRAM Main_poisson_binary_2pot_test_3mpt
