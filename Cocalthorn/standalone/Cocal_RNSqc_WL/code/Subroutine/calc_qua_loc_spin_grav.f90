subroutine calc_qua_loc_spin_grav
  ...
  use interface_source_qua_loc_spin_grav
...
!
  ...
  do irs=nrf+1, nrf+10
    ...
    call source_qua_loc_spin_grav(soug_qua_loc_spin, irs)
...
end subroutine calc_qua_loc_spin_grav
