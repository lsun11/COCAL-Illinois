subroutine printout_physq_peos(iseq,flag_restmass)
  ...
  use def_quantities
  implicit none
  real(8) :: fixeddlm, fixedvir, fixedvir_asymp
  real(8) :: omega
...
!
  if (iseq.eq.1) then 
    ...
    open(100,file='rnsphyseq.dat',status='old',position='append')
  end if
!
...
!
  close(100)
!
end subroutine printout_physq_peos
