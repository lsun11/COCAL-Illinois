module grid_parameter_1D
  use phys_constant, only : long
  use def_matter_1D, only : emdc, pinx, rhoc_qs
...
end subroutine read_parameter_1D

subroutine read_parameter_1D_surf
  implicit none

  open(1,file='rnspar_surf.dat',status='old')
  read(1,'(i5)') nrg_1
  read(1,'(1p,1e23.15)') r_surf
  close(1)
end subroutine read_parameter_1D_surf

end module grid_parameter_1D
