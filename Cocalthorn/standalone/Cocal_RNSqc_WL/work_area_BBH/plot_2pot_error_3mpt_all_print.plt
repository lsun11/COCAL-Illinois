...
set output 'plot_2pot_error_3mpt_psi.eps'
plot \
...
u 1:(100.0*abs(($2-$3)/$3)) w l lt 1 lw 2 notitle, \
"../work_area_poisson_test_D1/plot_x_mpt3.dat" \
u 1:(100.0*abs(($2-$3)/$3)) w l lt 1 lw 2 notitle, \
...
u 1:(100.0*abs(($2-$3)/$3)) w l lt 2 lw 2 notitle, \
"../work_area_poisson_test_D2/plot_x_mpt3.dat" \
u 1:(100.0*abs(($2-$3)/$3)) w l lt 2 lw 2 notitle, \
...
u 1:(100.0*abs(($2-$3)/$3)) w l lt 3 lw 2 notitle, \
"../work_area_poisson_test_D3/plot_x_mpt3.dat" \
u 1:(100.0*abs(($2-$3)/$3)) w l lt 3 lw 2 notitle, \
...
u 1:(100.0*abs(($2-$3)/$3)) w l lt 4 lw 2 notitle, \
"../work_area_poisson_test_D4/plot_x_mpt3.dat" \
u 1:(100.0*abs(($2-$3)/$3)) w l lt 4 lw 2 notitle
...
{/Helvetica=32 |}{/Helvetica=44 > }{/Helvetica=32 [%]}"
set output 'plot_2pot_error_3mpt_alpha.eps'
plot \
"../work_area_poisson_test_D1/plot_x_mpt1.dat" \
