...
#
## TAG=pBH
## filename_Maincode=./Main_code/Main_pBH_CF.f90
# TAG=MRNS
...
#!!!! TAG=RNS_WL_peos
#!!!! filename_Maincode=./Main_code/Main_RNS_WL_peos.f90
### 
TAG=RNS_HS_peos
### 
filename_Maincode=./Main_code/Main_RNS_HS_peos.f90
#Plot util TAG=RNS_CF_peos_plot
#Plot util filename_Maincode=./Main_utility/interpolation_main.f90
#Plot util #TAG=plot_MRNS
#Plot util #filename_Maincode=./Main_utility/interpolation_contour_potential_MRNS.f90
...
sed -i "/cpu_time\.f90/d" ${incfile_subrou}
