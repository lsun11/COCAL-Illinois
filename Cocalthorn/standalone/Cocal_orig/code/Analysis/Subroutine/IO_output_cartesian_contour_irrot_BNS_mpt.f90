subroutine IO_output_cartesian_contour_irrot_BNS_mpt(impt)
  use phys_constant, only : long
  use def_metric_cartesian, only  : alphca, psica, bvxdca, bvydca, bvzdca
  use def_matter_cartesian, only  : emdca, vxca, vyca, vzca, vepca
...
!
     ...
     &  emdc, vxc, vyc, vzc, psic, alphc, bvxc, bvyc, bvzc, vepc, hhc, rhoc
!
    end do
  end do
  close(14)
...
!
  ...
  close(14)
!
end subroutine IO_output_cartesian_contour_irrot_BNS_mpt
