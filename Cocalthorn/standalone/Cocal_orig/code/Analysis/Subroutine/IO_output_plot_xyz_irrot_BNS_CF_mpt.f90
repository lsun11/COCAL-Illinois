subroutine IO_output_plot_xyz_irrot_BNS_CF_mpt(impt)
...
!
  ...
  do irg = nrg, 0, -1
    write(12,'(1p,10e20.12)') -rg(irg),  psi(irg,ntgeq,npgyzm)  &
  ...
  write(12,*) ' '
  do irg = 0, nrg
    write(12,'(1p,10e20.12)') rg(irg),  psi(irg,ntgeq,npgyzp)  &
...
!
  ...
  do irg = nrg, 0, -1
    write(12,'(1p,10e20.12)') -rg(irg),  psi(irg,ntgpolm,0)  &
    &                                 , alph(irg,ntgpolm,0)  &
    &                                 , bvxd(irg,ntgpolm,0)  &
    &                                 , bvyd(irg,ntgpolm,0)  &
    &                                 , bvzd(irg,ntgpolm,0)  &
  ...
  write(12,*) ' '
  do irg = 0, nrg
    write(12,'(1p,10e20.12)') rg(irg),  psi(irg,ntgpolp,0) &
    &                                , alph(irg,ntgpolp,0) &
    &                                , bvxd(irg,ntgpolp,0) &
    &                                , bvyd(irg,ntgpolp,0) &
    &                                , bvzd(irg,ntgpolp,0) &
  ...
  close(12)
!
end subroutine IO_output_plot_xyz_irrot_BNS_CF_mpt
