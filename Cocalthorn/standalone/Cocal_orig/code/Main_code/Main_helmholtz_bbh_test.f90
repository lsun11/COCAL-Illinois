...
include '../Module_interface/interface_helmholtz_solver_binary_bhex_homosol.f90'
include '../Module_interface/interface_helmholtz_solver_bhex_surf_int.f90'
...
include '../Subroutine/iteration_helmholtz_solver_bbh_test.f90'
...
include '../Subroutine/helmholtz_solver_binary_bhex_homosol.f90'
include '../Subroutine/helmholtz_solver_binary_vol_int.f90'
include '../Subroutine/helmholtz_solver_binary_surf_int.f90'
include '../Subroutine/helmholtz_solver_bhex_surf_int.f90'
...
!              Main Program
!______________________________________________
PROGRAM Main_helmholtz_bbh_test
!
...
! 
  call iteration_helmholtz_solver_bbh_test(iter_count)
...
!
END PROGRAM Main_helmholtz_bbh_test
