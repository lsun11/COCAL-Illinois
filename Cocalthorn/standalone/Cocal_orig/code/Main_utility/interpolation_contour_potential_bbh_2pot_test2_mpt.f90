...
!______________________________________________
PROGRAM interpolation_contour_potential_binary_test2_mpt
!
...
!    call test_analytic_BHNS_solution_mpt(impt)
    call test2_analytic_solution_bhex_mpt(impt)
...
!
END PROGRAM interpolation_contour_potential_binary_test2_mpt
