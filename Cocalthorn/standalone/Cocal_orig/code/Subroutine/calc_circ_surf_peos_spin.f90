subroutine calc_circ_surf_peos_spin(impt)
  ...
  use interface_source_circ_surf_peos_spin
...
!
  ...
  do ia = nrf,nrf  
    ...
    call source_circ_surf_peos_spin("ph", ia, ib, souf_circ_surf_ph_peos)
...
!  write(6,'(a90)') "---------------------------------------------------------------------------------------------"
  do ia = nrf,nrf  
    ...
    call source_circ_surf_peos_spin("th", ia, ib, souf_circ_surf_th_peos)
...
end subroutine calc_circ_surf_peos_spin
