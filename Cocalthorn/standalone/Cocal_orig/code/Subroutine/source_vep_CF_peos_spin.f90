...
!
        ...
        hut(ir,it,ip) = (lam + sqrt(lam*lam + 4.0d0*alpfc2*wterm))/(2.0d0*alpfc2)
...
!
        ...
        call flgrad_midpoint_type0(wxspf,dxwx,dywx,dzwx,ir,it,ip)
        call flgrad_midpoint_type0(wyspf,dxwy,dywy,dzwy,ir,it,ip)
        call flgrad_midpoint_type0(wzspf,dxwz,dywz,dzwz,ir,it,ip)
        divw = dxwx + dywy + dzwz
!
