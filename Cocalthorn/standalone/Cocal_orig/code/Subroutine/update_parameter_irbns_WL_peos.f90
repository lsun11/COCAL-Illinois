subroutine update_parameter_irbns_WL_peos(convf)
...
!
  ...
  loghc = dlog(hc)
  vphiyin =  vec_phig(nrf,ntgeq,npgxzm,2)
  ...
  numero = 1
! ################################################################ 
  ain = dlog(alph(nrf,ntgeq,npgxzm)**(1.d0/radi**2))
  pain= (psi(nrf,ntgeq,npgxzm)**2/alph(nrf,ntgeq,npgxzm))**(1.d0/radi**2)
  bin = bvxd(nrf,ntgeq,npgxzm)
  gin = 1.0d0+hxxd(nrf,ntgeq,npgxzm)
!
...
!
end subroutine update_parameter_irbns_WL_peos
