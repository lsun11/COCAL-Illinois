subroutine IO_input_initial_3D_CF_BH_mpt(impt)
...
!
! --- Metric potentials.
  open(13,file='rnsgra_3D_mpt'//np(impt)//'.ini',status='old')
...
!
! --- Coordinate grids.
  open(14,file='rnsgrids_3D_mpt'//np(impt)//'.ini',status='old')
  ...
  close(14)
!
end subroutine IO_input_initial_3D_CF_BH_mpt
