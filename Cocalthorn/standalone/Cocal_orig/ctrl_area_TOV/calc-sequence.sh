cp ../parameters/TOV_code_parameters/peos_parameter.dat_G1=1.333_G2=3_rhodiv=1.8n0_prediv=40Mev_rhoc=4 peos_parameter.dat
...
cat ovphy.dat >> TOV_EOS_II_phy.dat
cat ovphy_plot.dat >> TOV_EOS_II_phy_plot.dat
