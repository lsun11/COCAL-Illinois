...
plot "HaC_phi000.txt" u 1:(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" title "HaC",\
     "HaC_phi180.txt" u (-($1)):(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" notitle

set output 'Hac_vio_1D_mid.eps'
plot "HaC_phi000_mid.txt" u 1:(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" title "HaC",\
     "HaC_phi180_mid.txt" u (-($1)):(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" notitle

set ylabel "{/Helvetica=28 MoC}"
set output 'MoC_vio_1D.eps'
plot "MoC_by_phi000.txt" u 1:(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" title "{/Symbol=28 b}^y",\
     "MoC_by_phi180.txt" u (-($1)):(log10(abs($2))) w lp lw 1 lt 1 lc rgb "#FF0000" notitle 
