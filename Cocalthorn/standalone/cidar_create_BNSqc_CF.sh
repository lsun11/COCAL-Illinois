...
#  RNSwl: Rotating NS in waveless formalism                                 #
#  RNSqc: Rotating NS in CF with quark core                                 #
#                                                                           #
compact_object=BNSqc
#                                                                           #
#############################################################################
...
path_to_src=/home/atsok/repositories/cocal_illinois/Cocalthorn                                                                                                                   
path_to_lib=/home/atsok/repositories/cocal_illinois/lib
FCOMP=gfortran
#FCOMP=ifort
FFLAGS=
#-O2
...
#  sh select_coc2pri_grid3.sh    #  r_surf < 1.0
  sh select_coc2pri_grid4.sh    #  r_surf = 1.0  
...
/bin/cp -f  coc2pri.f90              ${path_to_src}/src/${new_dir_name}/Main_utility/
...
echo "Compiling code..."
${FCOMP} ${FFLAGS} -c coc2pri.f90;   rm *.mod

echo "Creating library..."
ar rcvf libcocalnsnsqc.a coc2pri.o 

rm coc2pri.o 

cp libcocalnsnsqc.a  ${path_to_lib}
echo "Copied library  libcocalnsnsqc.a" to ${path_to_lib}
ENDTIME=$(date +%s)
echo "----------------------------------------------------------------"
