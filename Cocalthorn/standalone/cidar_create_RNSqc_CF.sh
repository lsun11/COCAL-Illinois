...
/bin/cp -f  coc2pri_rs.f90           ${path_to_src}/src/${new_dir_name}/Main_utility/
...
echo "Compiling code..."
${FCOMP} ${FFLAGS} -c coc2pri_rs.f90;   rm *.mod

echo "Creating library..."
ar rcvf libcocalrnsqc.a coc2pri_rs.o

rm coc2pri_rs.o

cp libcocalrnsqc.a  ${path_to_lib}
echo "Copied library libcocalrnsqc.a" to ${path_to_lib}
ENDTIME=$(date +%s)
echo "----------------------------------------------------------------"
